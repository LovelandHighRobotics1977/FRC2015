 ...
 * @author Ali Persings
 * A wrapper class for Joystick that returns specified input from an XBox 360 
 * controller. Contains method to check input from the a, b, x, and y buttons; 
 * the left and right bumpers; and the axes for the left and right joysticks and 
 * triggers. The input channels for each of these controls are specified in an 
 * interior class of the RobotMap.
 */
public class XBoxController extends Joystick {
     ...
     * @param port The input port this controller occupies on the Driver Station
     * (1 <= x <= 4)
     */
     ...
     * @param number The input number on the controller to which this button is
     * to be mapped
     ...
     * @param command The command to be executed while A is held
     */
    ...
    /**
     * Sets the command to be run when the A button is released 
     * (a.get() becomes false)
     * @param command The command to be executed when A is released
     */
    ...
    /**
     * Sets the command to be run when the A button is pressed 
     * (a.get() becomes true)
     * @param command The command to be executed when A is pressed
     */
    ...
    /**
     * Sets the command to be run when the B button is released 
     * (b.get() becomes false)
     * @param command The command to be executed when B is released
     */
    ...
    /**
     * Sets the command to be run when the B button is pressed 
     * (b.get() becomes true)
     * @param command The command to be executed when B is pressed
     */
     ...
     * @param command The command to be executed while B is held
     */
    ...
    /**
     * Sets the command to be run when the X button is pressed 
     * (x.get() becomes true)
     * @param command The command to be executed when X is pressed
     */
     ...
     * @param command The command to be executed while X is held
     */
    ...
    /**
     * Sets the command to be run when the X button is released 
     * (x.get() becomes false)
     * @param command The command to be executed when X is released
     */
    ...
    /**
     * Sets the command to be run when the Y button is released 
     * (y.get() becomes false)
     * @param command The command to be executed when Y is released
     */
    ...
    /**
     * Sets the command to be run when the Y button is pressed 
     * (y.get() becomes true)
     * @param command The command to be executed when Y is pressed
     */
     ...
     * @param command The command to be executed while Y is held
     */
     ...
     * @param command The command to be executed when the left bumper is pressed
     */
     ...
     * @param command The command to be executed while the left bumper is held
     */
     ...
     * @param command The command to be executed when the left bumper is 
     * released
     */
     ...
     * @param command The command to be executed when the right bumper is 
     * pressed
     */
     ...
     * @param command The command to be executed while right bumper is held
     */
